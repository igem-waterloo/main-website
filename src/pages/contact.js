  ...
  return (
    <Layout>
      <div className="flex flex-col md:flex-row md:items-start md:space-x-64">
        <h1 class="font-bg-m text-4xl text-teal border-b-2 border-yellow">
          Contact
        </h1>
        <div className="flex flex-col justify-start">
          <h2 class="mt-8 md:mt-4 mb-2 text-teal text-2xl font-bg-r">
            General Inquiries
          </h2>
          <a href={`mailto:uwigem@gmail.com`} class="font-nunito text-blue">
            uwigem@gmail.com
          </a>

          <h2 class="mt-8 mb-2 text-teal text-2xl font-bg-r">
            Lab &amp; Design
          </h2>
          <a
            href={`mailto:design.lab.uwigem@gmail.com`}
            class="font-nunito text-blue"
          >
